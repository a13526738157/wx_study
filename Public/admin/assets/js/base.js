var Base = {
    ...
    * @param a 选择器
    * @param b 获取url
    * @param c 数据 {xxx:function(){return x},xxx1:function(){return x}}
    */
    renderTable:function(a,b,c){
            var _this = this;
            if(this.tableInit){
            ...
            this.tableInit = true;
            _this.table = $(a).DataTable({
                "ajax": {
                    url : b,
                    data:c
                },
                "dom": "t<'am-u-sm-12 am-u-md-6 am-u-lg-6'i><'am-u-sm-12 am-u-md-6 am-u-lg-6'p>",
                  //"aaSorting": [[ 1, "DESC" ]],
                "ordering":false,
                "scrollX":false,
                "serverSide": true,
